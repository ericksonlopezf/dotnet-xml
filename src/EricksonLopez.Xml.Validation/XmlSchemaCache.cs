...
public sealed class XmlSchemaCache : IXmlSchemaCache, IXmlSchemaSetProvider
{
    ...
    /// <inheritdoc/>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Major Vulnerability", "S6640:Avoid using unsafe code blocks", Justification = "UnmanagedMemoryStream over ReadOnlySpan is required for zero-allocation schema compilation.")]
